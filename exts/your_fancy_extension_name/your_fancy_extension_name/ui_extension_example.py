...
def some_public_function(x: int):
    print("[your_fancy_extension_name] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[your_fancy_extension_name] startup")
    ...
    def on_shutdown(self):
        print("[your_fancy_extension_name] shutdown")
