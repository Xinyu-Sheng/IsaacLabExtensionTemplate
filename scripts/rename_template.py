...
It renames all the occurrences of your_fancy_extension_name (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    old_name = "your_fancy_extension_name"
    new_name = sys.argv[1]
    ...
    if proceed.lower() == "y":
        # rename the your_fancy_extension_name folder
        os.rename(
            os.path.join(root_dir_path, "exts", "your_fancy_extension_name", "your_fancy_extension_name"),
            os.path.join(root_dir_path, "exts", "your_fancy_extension_name", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "your_fancy_extension_name"), os.path.join(root_dir_path, "exts", new_name))
